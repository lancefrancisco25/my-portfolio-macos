    ...
    return (
        <div>
            ...
            <div className={css.videoCont}>
                <video ref={video} style={{width: '100%', height: '100%', objectFit: 'cover'}} src="https://res.cloudinary.com/duw2s4w0s/video/upload/v1633263036/macos_wallpaper_2_enuuqh.mp4"/> 
            </div>
        </div>
    )
}
